"""
Standalone test script for Zen lexer - includes all necessary code.
"""
...
# Import the new lexer directly
from lexer.lexer_v2 import Lexer, TokenType, Token, KEYWORDS
